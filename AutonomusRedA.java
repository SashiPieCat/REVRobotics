...
@Autonomous(name="AutonomusRedA", group="Linear Opmode")

public class AutonomusRedA extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        // spin code right to face backdrop
        runtime.reset();
        leftFrontDrive.setPower(-DRIVESPEED);
        leftBackDrive.setPower(-DRIVESPEED);
        rightFrontDrive.setPower(-DRIVESPEED);
